											...
											<div class="widget-main">
												...
												<div class="step-content row-fluid position-relative"
													...
													<div class="step-pane active" id="step1">
														...
														<sf:form action="${pageContext.request.contextPath}/jewel/addJewel" modelAttribute="jewel"
														...
														<div class="fileinput fileinput-new" data-provides="fileinput">
  								 							...
  								 							<div>
   								 								<span class="btn btn-default btn-file"><span class="fileinput-new">选择图片</span><span class="fileinput-exists">更改</span><input type="file" name="jewelimage"></span>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<select id="kind" class="form-control" style="width:30%;display:inline-block">
 																			<option value="1" selected='true'>3D硬千足金</option>
  																			<option value="2">珠宝类</option>
																			<option value="3">闪沙系列</option>
																		</select>
																		<select id="type" class="form-control" style="width:30%;display:inline-block">
																			<c:forEach items="${typelist}" var="types">
																				<option value="${types.jewelType.typeid }">${types.jewelType.typename }</option>
																			</c:forEach>
																		</select>
																		<sf:select path="typeno" style="width:30%;display:inline-block" class="form-control">
 																			<c:forEach items="${typelist}" begin="0" end="0" step="1" var="types">
