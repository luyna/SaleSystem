			...
			<div class="main-content" style="margin-left:4%;margin-top:6%">
				<div class="page-content">
					<!-- <div class="page-header">
						<h1>
							<a href="/content_homePage">资料数据查询系统</a><small> <i class="icon-double-angle-right"></i> 修改密码
							</small>
						</h1>
					</div> -->
					<!-- /.page-header -->
											...
											<div class="widget-main">
												...
												<div class="step-content row-fluid position-relative"
													...
													<div class="step-pane active" id="step1">
														...
														<sf:form action="${pageContext.request.contextPath}/user/alterAdminPassword" modelAttribute="passwordContent"
