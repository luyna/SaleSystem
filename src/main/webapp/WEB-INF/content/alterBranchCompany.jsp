											...
											<div class="widget-main">
												...
												<div class="step-content row-fluid position-relative"
													...
													<div class="step-pane active" id="step1">
														...
														<sf:form action="${pageContext.request.contextPath}/user/alterBranchCompany" modelAttribute="branchCompany"
															class="form-horizontal " id="validation-form"
															method="post">
															<div class="space-2"></div>
															<div class="form-group">
																<label
																	class="control-label col-xs-12 col-sm-3 no-padding-right">分店编号:</label>
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<sf:input path="companyid" readonly="true"
